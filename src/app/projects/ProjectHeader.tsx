...
const ProjectHeader = ({activeTab , setActiveTab}: Props) => {
  ...
  <div className='px-4 xl:px-6'>
    {/* component contain the new projet creation while clicking on it */}
     <ModalNewProject
  ...
  <div className='pb-6 pt-6 lg:pb-4 lg:pt-8'>
   ...
   //button new project containing a modal open to create new project containing fields
   buttonComponent={
      ...
      <div className='relative'>
        <input type='text' placeholder='Search Task' 
               className='rounded-md border py-1 pl-10 pr-4 focus:outline-none dark:border-dark-secondary dark:bg-dark-secondary dark:text-white'/>
                <Grid3X3 className='absolute left-3 top-2 h-4 w-4 text-gray-400 dark:bg-neutral-500' />
      </div>
    </div>
  </div>
  </div>
