...
type Props = {
//Anything passed inside the <Modal> component will be rendered as the content of the modal.
  children: React.ReactNode; //Dynamic content to display in the modal
  isOpen: boolean;
  onClose: () => void;
  name: string;
};
...
const Modal = ({ children, isOpen, onClose, name }: Props) => {
  ...
  //ReactDOM.createportal is to mask everything behind when the modal is open
